...
--
-- Temporary table structure for view `householdstate`
--

DROP TABLE IF EXISTS `householdstate`;
/*!50001 DROP VIEW IF EXISTS `householdstate`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `householdstate` (
  `householdID` int(11),
  `runID` int(11),
  `tick` double,
  `stage` varchar(12),
  ...
  `other` int(11),
  `harvestacai` double,
  `harvestmanioc` double,
  `harvesttimber` double
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `linkedhouseholdcount`
--

DROP TABLE IF EXISTS `linkedhouseholdcount`;
/*!50001 DROP VIEW IF EXISTS `linkedhouseholdcount`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `linkedhouseholdcount` (
  `runID` int(10),
  `householdID` int(11),
  `tick` double,
  `links` bigint(21)
...
--
-- Temporary table structure for view `sensitivity`
--

DROP TABLE IF EXISTS `sensitivity`;
/*!50001 DROP VIEW IF EXISTS `sensitivity`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `sensitivity` (
  `householdID` int(11),
  `runID` int(11),
  `tick` double,
  `stage` varchar(12),
...
--
-- Table structure for table `tblhouseholdmembers`
--

DROP TABLE IF EXISTS `tblhouseholdmembers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Temporary table structure for view `viewrun`
--

DROP TABLE IF EXISTS `viewrun`;
/*!50001 DROP VIEW IF EXISTS `viewrun`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `viewrun` (
  `runID` int(11),
  `labourMultiplier` double,
  `capitalMultiplier` double,
  `acaiMultiplier` double,
  ...
  `harvestManiocLabour` double,
  `harvestTimberLabour` double,
  `percentHeuristicHouseholds` double,
  `percentOptimalHouseholds` double,
  `percentForwardOptimalHouseholds` double,
  `percentFullForwardOptimalHouseholds` double,
  `numHouseholds` int(11),
  `numPersons` int(11),
  `numOffers` int(11),
  `acaiPrice` double,
  `maniocPrice` double,
  `timberPrice` double,
  `sweepName` varchar(128),
  `offerValueLow` double,
  `offerValueHigh` double,
  `lambdaOffers` double,
  `randomSeed` int(11),
  `offerValueAverage` double
) ENGINE=MyISAM */;
...
/*!50001 DROP TABLE IF EXISTS `avghouseholdstate`*/;
/*!50001 DROP VIEW IF EXISTS `avghouseholdstate`*/;
...
/*!50001 DROP TABLE IF EXISTS `endingaveragecapitallabour`*/;
/*!50001 DROP VIEW IF EXISTS `endingaveragecapitallabour`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 DROP TABLE IF EXISTS `endinghouseholdstate`*/;
/*!50001 DROP VIEW IF EXISTS `endinghouseholdstate`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
--
-- Final view structure for view `householdstate`
--

/*!50001 DROP TABLE IF EXISTS `householdstate`*/;
/*!50001 DROP VIEW IF EXISTS `householdstate`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 VIEW `householdstate` AS select distinct `tblhouseholdstate`.`householdID` AS `householdID`,`tblhouseholdstate`.`runID` AS `runID`,`tblhouseholdstate`.`tick` AS `tick`,`tblhouseholdstate`.`stage` AS `stage`,`tblhouseholdstate`.`capital` AS `capital`,`tblhouseholdstate`.`labour` AS `labour`,`tblhouseholdstate`.`acai` AS `acai`,`tblhouseholdstate`.`maniocgarden` AS `maniocgarden`,`tblhouseholdstate`.`fields` AS `fields`,`tblhouseholdstate`.`forest` AS `forest`,`tblhouseholdstate`.`fallow` AS `fallow`,`tblhouseholdstate`.`other` AS `other`,`tblhouseholdstate`.`harvestacai` AS `harvestacai`,`tblhouseholdstate`.`harvestmanioc` AS `harvestmanioc`,`tblhouseholdstate`.`harvesttimber` AS `harvesttimber` from (`tblhouseholdstate` join `tblland` on(((`tblland`.`owner` = `tblhouseholdstate`.`householdID`) and (`tblhouseholdstate`.`runID` = `tblland`.`runid`)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `linkedhouseholdcount`
--

/*!50001 DROP TABLE IF EXISTS `linkedhouseholdcount`*/;
/*!50001 DROP VIEW IF EXISTS `linkedhouseholdcount`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `linkedhouseholdcount` AS select `tblurbanagent`.`runid` AS `runID`,`tblurbanagent`.`sourceHousehold` AS `householdID`,`tblurbanagentstate`.`tick` AS `tick`,count(`tblurbanagent`.`urbanagentid`) AS `links` from (`tblurbanagent` join `tblurbanagentstate` on(((`tblurbanagent`.`urbanagentid` = `tblurbanagentstate`.`urbanagentid`) and (`tblurbanagent`.`runid` = `tblurbanagentstate`.`runid`)))) group by `tblurbanagent`.`runid`,`tblurbanagent`.`sourceHousehold`,`tblurbanagentstate`.`tick` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `sensitivity`
--

/*!50001 DROP TABLE IF EXISTS `sensitivity`*/;
/*!50001 DROP VIEW IF EXISTS `sensitivity`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `sensitivity` AS select `s`.`householdID` AS `householdID`,`s`.`runID` AS `runID`,`s`.`tick` AS `tick`,`s`.`stage` AS `stage`,`s`.`capital` AS `capital`,`s`.`labour` AS `labour`,`s`.`acai` AS `acai`,`s`.`maniocgarden` AS `maniocgarden`,`s`.`fields` AS `fields`,`s`.`forest` AS `forest`,`s`.`fallow` AS `fallow`,`s`.`other` AS `other`,`s`.`harvestacai` AS `harvestacai`,`s`.`harvestmanioc` AS `harvestmanioc`,`s`.`harvesttimber` AS `harvesttimber`,((`r`.`offerValueHigh` + `r`.`offerValueLow`) / 2) AS `offerValueAverage`,`linkedhouseholdcount`.`links` AS `links` from ((`tblrun` `r` join `tblhouseholdstate` `s` on((`r`.`runID` = `s`.`runID`))) left join `linkedhouseholdcount` on(((`r`.`runID` = `linkedhouseholdcount`.`runID`) and (`s`.`householdID` = `linkedhouseholdcount`.`householdID`) and (`s`.`tick` = `linkedhouseholdcount`.`tick`)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `viewrun`
--

/*!50001 DROP TABLE IF EXISTS `viewrun`*/;
/*!50001 DROP VIEW IF EXISTS `viewrun`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `viewrun` AS select `tblrun`.`runID` AS `runID`,`tblrun`.`labourMultiplier` AS `labourMultiplier`,`tblrun`.`capitalMultiplier` AS `capitalMultiplier`,`tblrun`.`acaiMultiplier` AS `acaiMultiplier`,`tblrun`.`maniocMultiplier` AS `maniocMultiplier`,`tblrun`.`timberMultiplier` AS `timberMultiplier`,`tblrun`.`acaiLabour` AS `acaiLabour`,`tblrun`.`fallowLabour` AS `fallowLabour`,`tblrun`.`maniocLabour` AS `maniocLabour`,`tblrun`.`acaiCost` AS `acaiCost`,`tblrun`.`maniocCost` AS `maniocCost`,`tblrun`.`fallowCost` AS `fallowCost`,`tblrun`.`maintainAcaiLabour` AS `maintainAcaiLabour`,`tblrun`.`maintainAcaiCost` AS `maintainAcaiCost`,`tblrun`.`maintainManiocLabour` AS `maintainManiocLabour`,`tblrun`.`maintainManiocCost` AS `maintainManiocCost`,`tblrun`.`rundate` AS `rundate`,`tblrun`.`forestFallowLabour` AS `forestFallowLabour`,`tblrun`.`forestFallowCost` AS `forestFallowCost`,`tblrun`.`harvestAcaiLabour` AS `harvestAcaiLabour`,`tblrun`.`harvestManiocLabour` AS `harvestManiocLabour`,`tblrun`.`harvestTimberLabour` AS `harvestTimberLabour`,`tblrun`.`percentHeuristicHouseholds` AS `percentHeuristicHouseholds`,`tblrun`.`percentOptimalHouseholds` AS `percentOptimalHouseholds`,`tblrun`.`percentForwardOptimalHouseholds` AS `percentForwardOptimalHouseholds`,`tblrun`.`percentFullForwardOptimalHouseholds` AS `percentFullForwardOptimalHouseholds`,`tblrun`.`numHouseholds` AS `numHouseholds`,`tblrun`.`numPersons` AS `numPersons`,`tblrun`.`numOffers` AS `numOffers`,`tblrun`.`acaiPrice` AS `acaiPrice`,`tblrun`.`maniocPrice` AS `maniocPrice`,`tblrun`.`timberPrice` AS `timberPrice`,`tblrun`.`sweepName` AS `sweepName`,`tblrun`.`offerValueLow` AS `offerValueLow`,`tblrun`.`offerValueHigh` AS `offerValueHigh`,`tblrun`.`lambdaOffers` AS `lambdaOffers`,`tblrun`.`randomSeed` AS `randomSeed`,((`tblrun`.`offerValueHigh` + `tblrun`.`offerValueLow`) / 2) AS `offerValueAverage` from `tblrun` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2010-06-27 19:43:37

GRANT INSERT, UPDATE ON *.* TO 'maria'@'localhost';
