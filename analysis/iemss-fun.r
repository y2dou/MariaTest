...
econTrajectoryPair = function ( runID1, runID2, householdID1, householdID2, composite=FALSE, singleTrajectory=TRUE, capital=TRUE, labour=TRUE, xlim=NULL, ylim1=NULL, ylim2=NULL, capital.ylim=NULL, title1="", title2="", ...) {
  ...
  if (capital) {
    ...
    plot(capital ~ tick, data = d1, ylim=capital.ylim, pch=19, cex=0.3, col="blue",xlab="tick", axes=FALSE)
    lines(capital ~ tick, data = d1, col="blue")
    axis(2)
    ...
    plot(capital ~ tick, data = d2, ylim=capital.ylim, ylab="", pch=19, cex=0.3, col="blue",xlab="tick", axes=FALSE)
  ...
  if (labour) {
    plot(labour ~ tick, data = d2, ylim=c(0, max(d1$labour,d2$labour)), pch=19, cex=0.3, col="red", xlab="tick", ylab="", axes=FALSE)
