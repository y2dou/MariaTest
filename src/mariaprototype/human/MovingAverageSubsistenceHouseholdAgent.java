 ...
 * 
 */
public class MovingAverageSubsistenceHouseholdAgent extends SubsistenceHouseholdAgent {
	...
	public MovingAverageSubsistenceHouseholdAgent() {
		super();
	}
	
	public MovingAverageSubsistenceHouseholdAgent(int id) {
		super(id);
	}
