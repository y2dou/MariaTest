 ...
 * 
 */
public class MovingAverageMinLabourHouseholdAgent extends MinLabourHouseholdAgent {
	...
	public MovingAverageMinLabourHouseholdAgent() {
		super();
	}
	
	public MovingAverageMinLabourHouseholdAgent(int id) {
		super(id);
	}
